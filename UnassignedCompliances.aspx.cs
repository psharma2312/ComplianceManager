...
{
    public partial class UnassignedCompliances : System.Web.UI.Page
    {
        Int32 userId = 0;
        ...
        private void BindGridFiltered(int deptId = 0, int typeId = 0, int nature = 0, int priority = 0)
        {
            try
            {
                ...
                compliances = dal.LoadUnAssignedComplianceMasterForReport(deptId, typeId, nature, priority);
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            DAL dal = new DAL();
            var varCatalogue = dal.LoadUnAssignedComplianceMasterForReport(deptId, typeId, nature, priority);
            using (var workbook = new XLWorkbook())
            {
                ...
                string excelName = "UnAssignedComplianceReport_" + localTime.ToString("dd_MMM_yy_hh_mm_ss_tt");
                Response.Clear();
