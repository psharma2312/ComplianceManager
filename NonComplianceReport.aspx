<%@ Page Title="" Language="C#" MasterPageFile="~/ComplianceM.Master" AutoEventWireup="true" CodeBehind="NonComplianceReport.aspx.cs" Inherits="ComplianceManager.NonComplianceReport" %>
...
<div class="heading">
    <asp:Label ID="Label4" runat="server" Text="Non Compliances" />
</div>
<asp:Label ID="lblErrorMessage" runat="server" CssClass="error-message" Visible="false" />
    ...
    <div style="flex: 0 0 25%; min-width: 0;">
        ...
        <div  class="control-div">
             ...
             <asp:DropDownList ID="ddlPriority" runat="server" style="width: 160px;height:20px; font-size:12px;"></asp:DropDownList>
         </div>
