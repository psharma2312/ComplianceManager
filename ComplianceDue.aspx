<%@ Page Title="" Language="C#" MasterPageFile="~/ComplianceM.Master" AutoEventWireup="true" CodeBehind="ComplianceDue.aspx.cs" Inherits="ComplianceManager.ComplianceDue" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cntPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <div class="heading">
            <asp:Label ID="Label4" runat="server" Text="Compliance Due" />
        </div>
        ...
        <div style="display: flex; gap: 0px; margin: 5px 0; width: 100%;">
            ...
            <div style="flex: 0 0 30%; min-width: 0;">
                <div class="control-div">
                    ...
                    <asp:DropDownList ID="ddlTypeOfCompliance" runat="server" Style="width: 170px; height: 20px; font-size: 12px;"></asp:DropDownList>
                </div>
                ...
                <div class="control-div">
                    ...
                    <asp:DropDownList ID="ddlNatureOfCompliance" runat="server" Style="width: 170px; height: 20px; font-size: 12px;"></asp:DropDownList>
                </div>
            ...
            <div style="flex: 0 0 26%; min-width: 0;">
                <div class="control-div">
                    ...
                    <asp:DropDownList ID="ddlDepartmentFunction" runat="server" Style="width: 170px; height: 20px; font-size: 12px;"></asp:DropDownList>
                </div>
                <div class="control-div">
                    <asp:Label ID="lblPriority" runat="server" Text="Priority" AssociatedControlID="ddlPriority" CssClass="control-label" Style="width: 80px;" />
                    <asp:DropDownList ID="ddlPriority" runat="server" Style="width: 170px; height: 20px; font-size: 12px;"></asp:DropDownList>
                </div>
            ...
            <div style="flex: 0 0 33%; min-width: 0;">
                <div class="control-div">
                    <asp:Label ID="lblDueWithin" runat="server" Text="Due Within" AssociatedControlID="ddlDueWithin" CssClass="control-label" Style="width: 90px;" />
                    <asp:DropDownList ID="ddlDueWithin" runat="server" Style="width: 150px; height: 20px; font-size: 12px;" />
                </div>
