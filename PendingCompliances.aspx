<%@ Page Title="" Language="C#" MasterPageFile="~/ComplianceM.Master" AutoEventWireup="true" CodeBehind="PendingCompliances.aspx.cs" Inherits="ComplianceManager.PendingCompliances" %>
...
<div class="heading">
    <asp:Label ID="Label4" runat="server" Text="Pending Compliance with User" />
</div>
<asp:Label ID="lblErrorMessage" runat="server" CssClass="error-message" Visible="false" />
    ...
    <div style="flex: 0 0 26%; min-width: 0;">
        <div class="control-div">
            <asp:Label ID="lblUserName" runat="server" Text="User Name" AssociatedControlID="ddlUserName" CssClass="control-label" style="width: 8  0px;" />
            <asp:DropDownList ID="ddlUserName" runat="server" style="width: 160px;height:20px; font-size:12px;"></asp:DropDownList>
        </div>
...
<asp:GridView ID="gvCompliances" runat="server" AutoGenerateColumns="false" OnPageIndexChanging="gvCompliances_PageIndexChanging" 
    ...
    <Columns>
     ...
     <ItemTemplate>
        ...
        <ItemTemplate>
            <asp:Label ID="lblStatus" runat="server" Text='<%# Eval("ComplianceStatusName") %>' />
        </ItemTemplate>
