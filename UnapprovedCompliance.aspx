<%@ Page Title="" Language="C#" MasterPageFile="~/ComplianceM.Master" AutoEventWireup="true" CodeBehind="UnapprovedCompliance.aspx.cs" Inherits="ComplianceManager.UnapprovedCompliance" %>
...
<div class="heading">
    <asp:Label ID="Label4" runat="server" Text="Compliance Pending with Approver" />
</div>
<asp:Label ID="lblErrorMessage" runat="server" CssClass="error-message" Visible="false" />
    ...
    <div style="flex: 0 0 25%; min-width: 0;">
       <div class="control-div">
             <asp:Label ID="lblApprover" runat="server" Text="Approver" AssociatedControlID="ddlApprover" CssClass="control-label" style="width: 80px;" />
             <asp:DropDownList ID="ddlApprover" runat="server" style="width: 160px;height:20px; font-size:12px;"></asp:DropDownList>
         </div>
        <div  class="control-div">
